...
$row = sql_fetch("select count(*) as cnt from bbsmoney_deposit where mb_no = '".$member["mb_no"]."'");
$total_count = $row["cnt"];

$i=0;
$result = sql_query("select * from bbsmoney_deposit where mb_no = '".$member["mb_no"]."' order by no desc");
...
$skin_file = $bbs_skin_path.'/deposit_list.php';
