...
$sql_common = " from bbsmoney_withdraw a left join {$g5['member_table']} b on a.mb_no = b.mb_no ";
...
<select name="sfl" id="sfl">
    ...
    <option value="a.wallet_address"<?php echo get_selected($_GET['sfl'], "a.wallet_address", true); ?>>지갑주소</option>
...
<div class="tbl_head01 tbl_wrap">
    ...
    <tr class="<?php echo $bg; ?>">
        ...
        <td class="td_left"><?php echo $row['wallet_address']; ?></td>
